...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
    ...
    const setOpen = React.useCallback(
        (value: boolean | ((value: boolean) => boolean)) => {
            ...
            // This is not SSR safe, but it's okay since it's only used for the sidebar state
    ...
    React.useEffect(() => {
        const setMobile = () => setIsMobile(window.innerWidth < 768)
        setMobile()
    ...
    return (
        <div
            ...
            className={cn(
                ...
                "data-[collapsible=offcanvas]:data-[state=collapsed]:translate-x-[-100%]",
                ...
                "group-data-[sidebar-collapsible=offcanvas]:duration-300",
                variant === "floating"
                    ? "rounded-r-lg border border-sidebar-border"
                    : "border-r border-sidebar-border",
                variant === "inset" && "border-sidebar-border bg-background",
                className
            )}
            {...props}
        >
            <div data-sidebar="sidebar" className="flex h-full w-full flex-col bg-sidebar group-data-[collapsible=icon]:overflow-hidden">
                {children}
            </div>
        </div>
    )
